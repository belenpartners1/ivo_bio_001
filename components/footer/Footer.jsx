...
//     <footer
//       ref={footerRef}
//       className="relative overflow-hidden py-20 px-6 bg-gri border border-t-4 border-gray-200"
//     >
...
//                 >
//                   <span className="text-sm font-semibold text-gray-400 group-hover:text-gray-800 transition-colors">
//                     {social.icon}
//                   </span>
//                 </button>
//               ))}
...
//                   <div className="absolute bottom-2 right-2 w-6 h-6 text-gray-600 group-hover:text-gray-800 transition-colors opacity-0 group-hover:opacity-100">
//                     →
//                   </div>
//                 </a>
//               ))}
